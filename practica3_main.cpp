...
int main(int argv,char* argc[]) {
    ...
    Plane pIz = Plane(Point(-20, 0.0, 0.0), n_pDe, color_pared_xokas,color_pared_xokas,color_pared_xokas,aux,false,false);
    Plane pDe = Plane(Point(20, 0.0, 0.0), n_pIz, color_pared_xokas,color_pared_xokas,color_pared_xokas,aux,false,false);
    Plane fondo = Plane(Point(0.0,0.0,-100.0), n_fondo, color_gris,color_gris,color_gris,aux,false,true);
